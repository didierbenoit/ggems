...
constexpr std::array<std::uint64_t, 40U> k_expected_gamma_energies_micro_eV{{
...
constexpr std::array<double, 40U> k_expected_gamma_line_yields{{
  0.8325,    0.0000083, 0.00018,   0.000199,  0.0000033, 0.000035,   0.000033,
  0.0000112, 0.000698,  0.000016,  0.000023,  0.000789,  0.00001582, 0.000026,
  0.0001164, 0.000044,  0.001257,  0.0000298, 0.000007,  0.004229,   0.0000412,
  0.00266,   0.0128,    0.003788,  0.000029,  0.0000115, 0.0000126,  0.0000266,
  0.000011,  0.000798,  0.0000164, 0.000269,  0.000616,  0.000591,   0.00000582,
  0.0000083, 0.0000101, 0.0000141, 0.0000097, 0.0000142,
}};
...
constexpr std::array<std::uint64_t, 36U>
  k_expected_conversion_energies_micro_eV{{
