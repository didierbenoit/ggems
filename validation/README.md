# GGEMS Scientific Validation

This directory contains scientific validation material for GGEMS.

It is intentionally separated from:

- `tests/`, which contains fast unit and integration tests;
- `examples/`, which contains user-oriented demonstrations;
- `benchmarks/`, which measures performance.
