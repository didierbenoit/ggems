...
/*!
 * \brief Formatter specialisation for \c char32_t emitting UTF-8.
 *
 * This specialisation allows \c char32_t values to be formatted directly
 * with \c std::format and friends. Internally it converts the code point
