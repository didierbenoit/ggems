...
template <> struct UnitRegistry<CrossSectionUnitSet> {
  static constexpr std::array<UnitDefinition, 6U> units{{
      ...
      {.canonical_name = "Barn",
       ...
       .display_symbol = "barn",
       .aliases = {},
       .literal_suffix = "_barn",
       .scale = DecimalScale(12),
       .automatic_display = true},
      {.canonical_name = "Kilobarn",
       .symbol = "kbarn",
       .display_symbol = "kbarn",
       .aliases = {},
       .literal_suffix = "_kbarn",
