...
std::string ToString(GGEMSRandomEngine const engine) {
  switch (engine) {
...
GGEMSRandomEngine ParseRandomEngine(std::string_view const engine_name) {
...
std::uint32_t ToKernelEngineId(GGEMSRandomEngine const engine) noexcept {
