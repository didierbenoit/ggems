...
/*!
 * \file
 * \brief Defines elemental and compound material presets and exact-vacuum
 * construction.
 *
...
/*!
 * \brief Stores the 92 pure-element density presets from Hydrogen through
 * Uranium.
 */
constexpr std::array<ElementalMaterialRow, 92U> k_elemental_materials{
  {
...

    {
      ...
      .atomic_number = 5U,
      .density = 2.370e+0_g_cm3,
    },

    {
      .canonical_name = "Carbon",
      .atomic_number = 6U,
      .density = 1.700e+0_g_cm3,
    },
...
constexpr std::array<GGEMSMaterialComponent, 4U> k_air_composition{
  {
    {
      .atomic_number = 6U,
      .mass_fraction = 0.000124L,
    },
    {
      .atomic_number = 7U,
      .mass_fraction = 0.755268L,
    },
    {
      .atomic_number = 8U,
      .mass_fraction = 0.231781L,
    },
    {
      .atomic_number = 18U,
      .mass_fraction = 0.012827L,
    },
  },
};
...
constexpr std::array<GGEMSMaterialComponent, 2U> k_water_composition{
  {
    {
      .atomic_number = 1U,
      .mass_fraction = 0.111898L,
    },
    {
      .atomic_number = 8U,
      .mass_fraction = 0.888102L,
    },
  },
};
...
constexpr std::array<GGEMSMaterialComponent, 13U> k_adipose_composition{
  {
    {
      .atomic_number = 1U,
      .mass_fraction = 0.119477L,
    },

    {
      .atomic_number = 6U,
      .mass_fraction = 0.637240L,
    },

    {
      .atomic_number = 7U,
      .mass_fraction = 0.007970L,
    },

    {
      .atomic_number = 8U,
      .mass_fraction = 0.232333L,
    },

    {
      .atomic_number = 11U,
      .mass_fraction = 0.000500L,
    },

    {
      .atomic_number = 12U,
      .mass_fraction = 0.000020L,
    },

    {
      .atomic_number = 15U,
      .mass_fraction = 0.000160L,
    },

    {
      .atomic_number = 16U,
      .mass_fraction = 0.000730L,
    },

    {
      .atomic_number = 17U,
      .mass_fraction = 0.001190L,
    },

    {
      .atomic_number = 19U,
      .mass_fraction = 0.000320L,
    },
...
constexpr std::array<GGEMSMaterialComponent, 10U> k_blood_composition{
  {
    ...
    {
      .atomic_number = 7U,
      .mass_fraction = 0.033L,
    },

    {
      .atomic_number = 8U,
      .mass_fraction = 0.745L,
    },

    {
      .atomic_number = 11U,
      .mass_fraction = 0.001L,
    },
    ...
    {
      .atomic_number = 16U,
      .mass_fraction = 0.002L,
    },

    {
      .atomic_number = 17U,
      .mass_fraction = 0.003L,
    },
...
constexpr std::array<GGEMSMaterialComponent, 11U> k_blood_iodine5_composition{
  {
    {
      .atomic_number = 1U,
      .mass_fraction = 0.0971L,
    },

    {
      .atomic_number = 6U,
      .mass_fraction = 0.104L,
    },

    {
      .atomic_number = 7U,
      .mass_fraction = 0.0314L,
    },

    {
      .atomic_number = 8U,
      .mass_fraction = 0.708L,
    },

    {
      .atomic_number = 11U,
      .mass_fraction = 0.00095L,
    },
    ...
    {
      .atomic_number = 16U,
      .mass_fraction = 0.0019L,
    },

    {
      .atomic_number = 17U,
      .mass_fraction = 0.00285L,
    },
...
constexpr std::array<GGEMSMaterialComponent, 11U> k_blood_iodine10_composition{
  {
    {
      .atomic_number = 1U,
      .mass_fraction = 0.0918L,
    },

    {
      .atomic_number = 6U,
      .mass_fraction = 0.099L,
    },

    {
      .atomic_number = 7U,
      .mass_fraction = 0.0297L,
    },

    {
      .atomic_number = 8U,
      .mass_fraction = 0.6705L,
    },

    {
      .atomic_number = 11U,
      .mass_fraction = 0.0009L,
    },
    ...
    {
      .atomic_number = 16U,
      .mass_fraction = 0.0018L,
    },

    {
      .atomic_number = 17U,
      .mass_fraction = 0.0027L,
    },
...
constexpr std::array<GGEMSMaterialComponent, 11U> k_blood_iodine15_composition{
  {
    {
      .atomic_number = 1U,
      .mass_fraction = 0.0867L,
    },

    {
      .atomic_number = 6U,
      .mass_fraction = 0.0935L,
    },

    {
      .atomic_number = 7U,
      .mass_fraction = 0.02805L,
    },

    {
      .atomic_number = 8U,
      .mass_fraction = 0.63325L,
    },

    {
      .atomic_number = 11U,
      .mass_fraction = 0.00085L,
    },
    ...
    {
      .atomic_number = 16U,
      .mass_fraction = 0.0017L,
    },

    {
      .atomic_number = 17U,
      .mass_fraction = 0.00255L,
    },
...
constexpr std::array<GGEMSMaterialComponent, 11U> k_blood_iodine20_composition{
  {
    {
      .atomic_number = 1U,
      .mass_fraction = 0.0816L,
    },

    {
      .atomic_number = 6U,
      .mass_fraction = 0.088L,
    },

    {
      .atomic_number = 7U,
      .mass_fraction = 0.0264L,
    },

    {
      .atomic_number = 8U,
      .mass_fraction = 0.596L,
    },

    {
      .atomic_number = 11U,
      .mass_fraction = 0.0008L,
    },
    ...
    {
      .atomic_number = 16U,
      .mass_fraction = 0.0016L,
    },

    {
      .atomic_number = 17U,
      .mass_fraction = 0.0024L,
    },
...
constexpr std::array<GGEMSMaterialComponent, 13U> k_brain_composition{
  {
    {
      .atomic_number = 1U,
      .mass_fraction = 0.110667L,
    },

    {
      .atomic_number = 6U,
      .mass_fraction = 0.125420L,
    },

    {
      .atomic_number = 7U,
      .mass_fraction = 0.013280L,
    },

    {
      .atomic_number = 8U,
      .mass_fraction = 0.737723L,
    },

    {
      .atomic_number = 11U,
      .mass_fraction = 0.001840L,
    },

    {
      .atomic_number = 12U,
      .mass_fraction = 0.000150L,
    },

    {
      .atomic_number = 15U,
      .mass_fraction = 0.003540L,
    },

    {
      .atomic_number = 16U,
      .mass_fraction = 0.001770L,
    },

    {
      .atomic_number = 17U,
      .mass_fraction = 0.002360L,
    },

    {
      .atomic_number = 19U,
      .mass_fraction = 0.003100L,
    },

    {
      .atomic_number = 20U,
      .mass_fraction = 0.000090L,
    },

    {
      .atomic_number = 26U,
      .mass_fraction = 0.000050L,
    },

    {
      .atomic_number = 30U,
      .mass_fraction = 0.000010L,
    },
  },
};
...
constexpr std::array<GGEMSMaterialComponent, 8U> k_breast_composition{
  {
    {
      .atomic_number = 1U,
      .mass_fraction = 0.1060L,
    },

    {
      .atomic_number = 6U,
      .mass_fraction = 0.3320L,
    },

    {
      .atomic_number = 7U,
      .mass_fraction = 0.0300L,
    },

    {
      .atomic_number = 8U,
      .mass_fraction = 0.5270L,
    },

    {
      .atomic_number = 11U,
      .mass_fraction = 0.0010L,
    },
...
constexpr std::array<GGEMSMaterialComponent, 9U> k_heart_composition{
  {
    ...
    {
      .atomic_number = 6U,
      .mass_fraction = 0.139L,
    },

    {
      .atomic_number = 7U,
      .mass_fraction = 0.029L,
    },

    {
      .atomic_number = 8U,
      .mass_fraction = 0.718L,
    },
...
constexpr std::array<GGEMSMaterialComponent, 9U> k_intestine_composition{
  {
    {
      .atomic_number = 1U,
      .mass_fraction = 0.106L,
    },

    {
      .atomic_number = 6U,
      .mass_fraction = 0.115L,
    },

    {
      .atomic_number = 7U,
      .mass_fraction = 0.022L,
    },

    {
      .atomic_number = 8U,
      .mass_fraction = 0.751L,
    },
...
constexpr std::array<GGEMSMaterialComponent, 10U> k_kidney_composition{
  {
    {
      .atomic_number = 1U,
      .mass_fraction = 0.103L,
    },

    {
      .atomic_number = 6U,
      .mass_fraction = 0.132L,
    },
...
constexpr std::array<GGEMSMaterialComponent, 9U> k_lung_composition{
  {
    ...
    {
      .atomic_number = 6U,
      .mass_fraction = 0.105L,
    },

    {
      .atomic_number = 7U,
      .mass_fraction = 0.031L,
    },

    {
      .atomic_number = 8U,
      .mass_fraction = 0.749L,
    },
...
constexpr std::array<GGEMSMaterialComponent, 9U> k_rib_bone_composition{
  {
    {
      .atomic_number = 1U,
      .mass_fraction = 0.034L,
    },

    {
      .atomic_number = 6U,
      .mass_fraction = 0.155L,
    },

    {
      .atomic_number = 7U,
      .mass_fraction = 0.042L,
    },

    {
      .atomic_number = 8U,
      .mass_fraction = 0.435L,
    },
...
constexpr std::array<GGEMSMaterialComponent, 11U> k_spine_bone_composition{
  {
    {
      .atomic_number = 1U,
      .mass_fraction = 0.063L,
    },

    {
      .atomic_number = 6U,
      .mass_fraction = 0.261L,
    },

    {
      .atomic_number = 7U,
      .mass_fraction = 0.039L,
    },

    {
      .atomic_number = 8U,
      .mass_fraction = 0.436L,
    },
...
constexpr std::array<GGEMSMaterialComponent, 9U> k_spleen_composition{
  {
    ...
    {
      .atomic_number = 6U,
      .mass_fraction = 0.113L,
    },

    {
      .atomic_number = 7U,
      .mass_fraction = 0.032L,
    },

    {
      .atomic_number = 8U,
      .mass_fraction = 0.741L,
    },
...
constexpr std::array<GGEMSMaterialComponent, 2U> k_cdte_composition{
  {
    {
      .atomic_number = 48U,
      .mass_fraction = 0.468358L,
    },

    {
      .atomic_number = 52U,
      .mass_fraction = 0.531642L,
    },
  },
};
...
constexpr std::array<GGEMSMaterialComponent, 2U> k_csi_composition{
  {
    {
      .atomic_number = 53U,
      .mass_fraction = 0.488451L,
    },

    {
      .atomic_number = 55U,
      .mass_fraction = 0.511549L,
    },
  },
};
...
constexpr std::array<GGEMSMaterialComponent, 2U> k_gaas_composition{
  {
    {
      .atomic_number = 31U,
      .mass_fraction = 0.482030L,
    },

    {
      .atomic_number = 33U,
      .mass_fraction = 0.517970L,
    },
  },
};
...
constexpr std::array<GGEMSMaterialComponent, 3U> k_gos_composition{
  {
    {
      .atomic_number = 8U,
      .mass_fraction = 0.084527L,
    },

    {
      .atomic_number = 16U,
      .mass_fraction = 0.084704L,
    },

    {
      .atomic_number = 64U,
      .mass_fraction = 0.830769L,
    },
  },
};
...
constexpr std::array<GGEMSMaterialComponent, 3U> k_lso_composition{
  {
    {
      .atomic_number = 8U,
      .mass_fraction = 0.174L,
    },

    {
      .atomic_number = 14U,
      .mass_fraction = 0.062L,
    },

    {
      .atomic_number = 71U,
      .mass_fraction = 0.764L,
    },
  },
};
...
constexpr std::array<GGEMSMaterialComponent, 2U> k_nai_composition{
  {
    {
      .atomic_number = 11U,
      .mass_fraction = 0.153L,
    },

    {
      .atomic_number = 53U,
      .mass_fraction = 0.847L,
    },
  },
};
...
/*!
 * \brief Associates each compound preset name with density and elemental mass
 * shares.
 */
  ...
  {
    {
      ...
      .composition = std::span<GGEMSMaterialComponent const>{k_air_composition},
    },

    {
      ...
      .density = 1.000_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_water_composition},
    },

    {
      ...
      .density = 0.92_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_adipose_composition},
    },

    {
      ...
      .density = 1.06_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_blood_composition},
    },

    {
      ...
      .density = 1.25_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_blood_iodine5_composition},
    },

    {
      ...
      .density = 1.44_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_blood_iodine10_composition},
    },

    {
      ...
      .density = 1.64_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_blood_iodine15_composition},
    },

    {
      ...
      .density = 1.834_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_blood_iodine20_composition},
    },

    {
      ...
      .density = 1.03_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_brain_composition},
    },

    {
      ...
      .density = 1.020_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_breast_composition},
    },

    {
      ...
      .density = 1.05_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_heart_composition},
    },

    {
      ...
      .density = 1.03_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_intestine_composition},
    },

    {
      ...
      .density = 1.05_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_kidney_composition},
    },

    {
      ...
      .density = 1.06_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_liver_composition},
    },

    {
      ...
      .density = 0.26_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_lung_composition},
    },

    {
      ...
      .density = 1.92_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_rib_bone_composition},
    },

    {
      ...
      .density = 1.42_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_spine_bone_composition},
    },

    {
      ...
      .density = 1.06_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_spleen_composition},
    },

    {
      ...
      .density = 6.200_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_cdte_composition},
    },

    {
      .canonical_name = "CsI",
      .density = 4.510_g_cm3,
      .composition = std::span<GGEMSMaterialComponent const>{k_csi_composition},
    },

    {
      ...
      .density = 5.310_g_cm3,
      .composition =
        std::span<GGEMSMaterialComponent const>{k_gaas_composition},
    },

    {
      .canonical_name = "GOS",
      .density = 7.440_g_cm3,
      .composition = std::span<GGEMSMaterialComponent const>{k_gos_composition},
    },

    {
      .canonical_name = "LSO",
      .density = 7.4_g_cm3,
      .composition = std::span<GGEMSMaterialComponent const>{k_lso_composition},
    },

    {
      .canonical_name = "NaI",
      .density = 3.67_g_cm3,
      .composition = std::span<GGEMSMaterialComponent const>{k_nai_composition},
    },
  },
};
...
/*!
 * \brief Counts Vacuum, elemental presets, and compound presets in the name
 * catalog.
 */
...
/*!
 * \brief Builds the static preset-name list in its published iteration order.
 *
 * \return Vacuum first, then elemental names by Z, then compounds in table
 * order.
 */
...
/*!
 * \brief Expands a pure-element preset through the default isotope composition.
 *
 * \param[in] row Static elemental name, Z, and density preset.
 * \return An independently owned material with a unit elemental mass fraction.
 * \throws GGEMSRecoverable If default isotope or matter composition preparation
 * fails.
 */
...
/*!
 * \brief Copies a compound preset into isotope-aware material preparation.
 *
 * \param[in] row Preset name, density, and borrowed elemental mass fractions.
 * \return An independently owned material.
 * \throws GGEMSRecoverable If default isotope or matter composition preparation
 * fails.
 */
[[nodiscard]] auto BuildCompoundMaterial(CompoundMaterialRow const &row)
  -> GGEMSMaterial {
  return GGEMSMaterial{std::string{row.canonical_name}, row.density,
                       std::vector<GGEMSMaterialComponent>{
                         row.composition.begin(), row.composition.end()}};
}
