...
#define GGEMS_WRITE_RECORD_OFFSET(INDEX, FIELD)                                \
  ...
  GGEMS_WRITE_RECORD_OFFSET(21, source_index);
...
#define GGEMS_WRITE_CONFIG_OFFSET(INDEX, FIELD)                                \
  ...
  GGEMS_WRITE_CONFIG_OFFSET(25, capture_first_primary_count_per_source);
  GGEMS_WRITE_CONFIG_OFFSET(26, capture_specific_primary_enabled);
  GGEMS_WRITE_CONFIG_OFFSET(27, capture_source_index);
  GGEMS_WRITE_CONFIG_OFFSET(28, capture_source_local_primary_id);

#undef GGEMS_WRITE_CONFIG_OFFSET

  layout[29] = (ulong)((__global uchar const *)&configs[1] -
