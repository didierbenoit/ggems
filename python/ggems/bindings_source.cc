...
auto BindSource(py::module_ &module) -> void {
  ...
  py::class_<GGEMSSource, std::shared_ptr<GGEMSSource>>(module, "GGEMSSource")
    ...
    .def(
      "set_radionuclide",
      [](GGEMSSource &self, RadionuclideDefinitionHandle const &radionuclide,
         double activity, std::string const &activity_unit,
         double reference_time, std::string const &time_unit) -> GGEMSSource & {
    ...
    .def("set_orientation", &GGEMSSource::SetOrientation, py::arg("direction"),
         py::arg("up"), py::return_value_policy::reference_internal)
