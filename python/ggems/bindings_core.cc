...
/*!
 * \file
 * \brief Defines Python bindings for GGEMS core output and logging controls.
 *
...
/*!
 * \brief Registers GGEMS core output and logging bindings in a Python module.
 *
 * \param[in,out] m Python core submodule receiving the bindings.
 */
void BindCore(py::module_ &m) {
  m.doc() = R"doc(GGEMS core output and logging controls.
...
Example:
    ggems.core.set_output_file("ggems.log")
)doc");
...
Example:
    ggems.core.GGEMSLogger().set_detail_level(2)
)doc")
